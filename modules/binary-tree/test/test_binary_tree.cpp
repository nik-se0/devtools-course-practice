...
TEST(Semenova_Veronika_Binary_Tree,
 Сan_insert_node_in_tree) {
    BinaryTree t(3);
    ASSERT_NO_THROW(t.Insert(2));
}
TEST(Semenova_Veronika_Binary_Tree,
 Сan_find_value_in_empty_tree) {
    BinaryTree t;
...
TEST(Semenova_Veronika_Binary_Tree,
 Сan_not_insert_repeated_node_in_tree) {
    BinaryTree t(3);
...
TEST(Semenova_Veronika_Binary_Tree,
 Сan_not_delete_node_in_empty_tree) {
    BinaryTree t;
