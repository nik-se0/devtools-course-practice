...
|---|---|---|
| Алгоритм Хаффмана |||
| Сортировка (не "пузырьковая") |Пашина А. 382008-1||
| Реализовать [бинарный поиск](http://codekata.com/kata/kata02-karate-chop/) |Селиванкин С. 382008-1||
...
| Шифр Цезаря | Колесов М. (382008-1) ||
...
| Дерево (построение, поиск по значению) |Семенова В. 382003_3||
